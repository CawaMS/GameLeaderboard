...
1. Modify or add environment variables to configure the running application. Environment variables can be configured by modifying the `env` node in the following files:
    - [app/GameLeaderboard.bicep](./infra/app/GameLeaderboard.bicep)
...
- [app/GameLeaderboard.bicep](./infra/app/GameLeaderboard.bicep) - Azure Container Apps resources to host the 'GameLeaderboard' service.
